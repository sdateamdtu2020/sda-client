...
import { useStyles } from "./AfforestationPeriodOfCity.elements";
import {
	IconButton,
	InputLabel,
	MenuItem,
...
const AfforestationPeriodOfCity = ({ id, data, inputs, outputs }) => {
...
export default AfforestationPeriodOfCity;
