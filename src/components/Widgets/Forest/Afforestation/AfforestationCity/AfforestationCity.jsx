...
import { useStyles } from "./AfforestationCity.elements";
...
import { treeAfforestation } from "../../../../../data/index";
...
const AfforestationCity = ({ id, data, inputs, outputs }) => {
		...
		<div className={classes.node}>
			<div className={classes.header}>
				...
				<div className={classes.headerCenter}>
					<p className={classes.headerTitle}>{treeAfforestation.name}</p>
				</div>
			...
			<div className={classes.body}>
				...
				>
					<TreeItem
						nodeId={`${treeAfforestation.id}-${treeAfforestation.city.id}`}
						label={treeAfforestation.city.name}
					>
						{treeAfforestation.city.children.map((item) => (
							<TreeItem
								nodeId={`${treeAfforestation.id}-${treeAfforestation.city.id}-${item.id}`}
								label={item.name}
								key={item.id}
							/>
						))}
...
export default AfforestationCity;
